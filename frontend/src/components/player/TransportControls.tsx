...
export default function TransportControls({
  ...
  return (
    <div className="grid grid-cols-[8.75rem_1fr_10rem] gap-x-4 w-full items-center">
      ...
      {/* Centre: progress bar with times on top */}
      <div className="relative">
        ...
        <div
          className="h-1.5 bg-surface-container-highest rounded-full overflow-hidden cursor-pointer relative group"
          onClick={(e) => {
            if (!isReady) return
