# Subset of backend/app/tasks/repository.py for the transcription container.
# Functions only needed by the backend (e.g. get_active_lyrics_task) are omitted.
# Keep shared functions in sync manually.
import aiosqlite
